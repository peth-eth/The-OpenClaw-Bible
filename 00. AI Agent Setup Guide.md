...
> **Note:** This guide is the quickstart. For deep dives on any topic — security hardening, multi-agent coordination, content pipelines, marketing automation — see the [full OpenClaw Bible chapters](./README.md#chapters) in this repo.

> **Not everything here applies to you.** After pasting Part 2 into your AI assistant, tell it your goals. It will recommend which phases to focus on and which to skip. A content creator doesn't need Phase 6's developer monitoring setup. A developer doesn't need the content curation workflow. Ask your LLM: "Based on my goals, which phases can I skip or simplify?"
...
2. Primary goal? (productivity, content creation, coding, research, business)
3. Budget preference? (minimal ~$5/mo, moderate ~$30/mo, power ~$100+/mo)
4. How comfortable with terminal? (beginner / intermediate / advanced)

**Based on their answers, recommend which phases to prioritize and which to skip or simplify.** Not everyone needs every phase. Content creators can skip Phase 4 security hardening details. Developers can skip the content-focused parts of Phase 5. Adjust accordingly — don't force everyone through the same path.
...
This guide covers the essentials. For the full reference on advanced topics, see the [OpenClaw Bible chapters](./README.md#chapters) in this repo:

- **[Security & Hardening](./03.%20Security%20%26%20Hardening.md)** — threat models, hardened SOUL.md templates, security audit checklists
- **[Life Automation Audit](./06.%20Life%20Automation%20Audit.md)** — the full systematic audit framework
- **[Skills System](./07.%20Skills%20System.md)** — advanced skill patterns, skill composition, community skills
- **[Tools & Plugins](./08.%20Tools%20%26%20Plugins.md)** — every integration option explained
- **[Cost Optimization](./09.%20Cost%20Optimization%20%26%20Model%20Routing.md)** — advanced routing, budget tracking, cost analysis
- **[Content Curation](./10.%20Content%20Curation%20%26%20Swipe%20Files.md)** — automated content pipelines
- **[Multi-Agent Coordination](./11.%20Multi-Agent%20Coordination.md)** — running multiple specialized agents
- **[Marketing Automation](./12.%20Marketing%20Automation%20%26%20Vibe%20Marketing.md)** — automated marketing workflows
