# 6. Life Automation Audit

Not sure what to automate? This chapter is for you. Before configuring skills and workflows, run this audit to discover every automation opportunity across your entire life.

Paste this prompt into any powerful LLM (Claude Opus/Sonnet recommended for the length). It will walk you through a structured conversation covering 9 life domains, then deliver a complete automation map with implementation guides.

---

## How It Works

1. **Phase 1 - Questionnaire:** The LLM interviews you across 9 domains (3-5 questions at a time, not overwhelming)
2. **Phase 2 - Automation Map:** Every automatable task scored by time saved, difficulty, cost, and impact
3. **Phase 3 - Implementation Guide:** Step-by-step setup instructions for each automation

Takes about 30-60 minutes. The output becomes your roadmap for what to build with OpenClaw.

---

## The Prompt

Copy and paste both parts into a new conversation (don't submit until both are pasted).
...
- **Large Language Models** (Claude 4.6, ChatGPT, Gemini 3.1) — and specific use cases
...
- **AI video generation** (Moonshot video, Runway, Pika) — text-to-video, editing, effects
...
- **Multi-agent orchestration** (OpenClaw sub-agents, nested delegation per domain)
...
Once you have your automation map, bring it to your OpenClaw:

> "Here are the automations I want to set up, in priority order: [paste your Top 10 Quick Wins]. Let's start with #1. Build a skill for it and set it up."

Work through them one at a time. Each automation becomes a skill, a cron job, or a workflow in your OpenClaw setup.

The audit output also helps you decide:
- Which [[07. Skills System|skills]] to build or install
- Which [[08. Tools & Plugins|tools]] you need
- What your [[02. Core Concepts & Architecture#Heartbeats|heartbeat]] schedule should look like
- What to put in your [[05. Use Cases & Workflows#Implementation Prompts|morning brief]]
